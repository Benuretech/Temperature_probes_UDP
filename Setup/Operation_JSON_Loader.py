"""
JSON configuration loader for the Operation system that manages operational database assembly.
Handles loading of operational configurations, serial number lists, and test settings with automatic
file discovery and version management for production workflow operations.
"""
...
# Format of the JSON:
# data_base["ConfigBase"]["SN_tooltype_list"]


# Loader class for Operation JSON configuration and database files
class Operation_JSON_Loader:
    def __init__(self):
    ...
    def Load(self, custom_file_path=None):
        """
        Loads the main Operation database and configuration files, including SN lists and test limits.
        ...
        # Load the main Operation database JSON
        Database_file_path = os.path.join(root_path, "Setup/Operation_database.json")
